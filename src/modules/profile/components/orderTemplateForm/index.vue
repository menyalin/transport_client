<template>
  <div>
    <ButtonsPanel
      panelType="form"
      :disabledSubmit="!$store.getters.hasPermission('orderTemplate:write') || isInvalidForm"
      @cancel="cancel"
      @submit="submit"
    />
    <div class="body-wrapper">
      <v-text-field v-model.trim="$v.form.name.$model" variant="outlined" label="Название шаблона" density="compact" />
      <div id="client-row">
        <v-autocomplete
