...
describe('getPeriodFromDatesSet', () => {
  ...
  it('period #1', () => {
    const period = getPeriodFromDatesSet(
      new Set(['2022-01-05', '2022-01-01', '2022-01-03'])
    )
  ...
  it('period #2', () => {
    const period = getPeriodFromDatesSet(
      new Set(['sdsds', '2022-01-01', '2022-01-05'])
    )
    expect(period).toEqual(['2022-01-01', '2022-01-05'])
  })
  ...
  it('period #3', () => {
    const period = getPeriodFromDatesSet(
      new Set(['sdsds', '2232wde-01-01', '20dsds22-01-05'])
    )
