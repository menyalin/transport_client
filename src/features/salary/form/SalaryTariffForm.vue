...
import AppPoints from './SalaryPoints.vue'
import AppZones from './SalaryZones.vue'
import AppRegions from './SalaryRegions.vue'
import AppAdditionalPoints from './SalaryAdditionalPoints.vue'
import AppWaiting from './SalaryWaiting.vue'
import AppReturn from './SalaryReturn.vue'
