...
import { useTariffContractForm } from './useTariffContractForm.js'
import TariffListWrapper from '@/entities/tariff_contract/form/tariffListWrapper.vue'
import ZoneBaseTariffList from '@/entities/tariff_contract/form/zonesBaseTariffList.vue'
import ZoneBaseTariffForm from './ZonesBaseTariffForm.vue'
import DirectDistanceZonesTariffList from '@/entities/tariff_contract/form/directDistanceZonesTariffList.vue'
...
import IdleTimeTariffList from '@/entities/tariff_contract/form/idleTimeTariffList.vue'
import ReturnPercentTariffForm from './ReturnPercentTariffForm.vue'
import ReturnPercentTariffList from '@/entities/tariff_contract/form/returnPercentTariffList.vue'
