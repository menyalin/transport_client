<template>
  <div class="docs-wrapper">
    ...
    <PaymentPartsTable v-else :items="preparedItems" :hideDelete="readonly || loading" @deleteRow="deleteRowHandler" />
    <PaymentPartFormDialog :routeDate="routeDate" :dialog="dialog" @submit="submitHandler" @close="closeDialog" />
  </div>
</template>
<script>
